...
const TestimonialsData03 = [
  {
    name: "Herman Miller",
    designation: "Professor of Design",
    content:
      "The innovative curriculum at this institution has transformed my approach to teaching and learning, fostering creativity among students.",
    img: "https://via.placeholder.com/125x125",
  },
  {
    name: "Jeremy Girard",
    ...
    content:
      "The integration of technology in the classroom has made a significant impact on student engagement and success in learning.",
    img: "https://via.placeholder.com/125x125",
  },
  {
    ...
    content:
      "This program has provided me with the necessary skills and knowledge to excel in my research and professional endeavors.",
    img: "https://via.placeholder.com/125x125",
  },
];
