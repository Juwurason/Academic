...
const serviceData2 = [
  {
    ...
    content:
      "Lorem ipsum dolor sit amet, adipiscing elit sed do eiusmod incididunt.",
    linkTitle: "More info",
...
const serviceData5 = [
  {
    ...
    content:
      "We provide tailored educational strategies that cater to individual learning styles for academic success.",
    link: "/",
  ...
  },
  {
    ...
    icon: "feather-arrow-right",
    content:
      "Our approach integrates modern techniques and tools to enhance student engagement and understanding.",
    link: "/",
    linkTitle: "Learn More",
  },
  {
    ...
    icon: "feather-arrow-right",
    content:
      "We prioritize student outcomes, ensuring a supportive environment that fosters growth and achievement.",
    link: "/",
    linkTitle: "Learn More",
  },
];
