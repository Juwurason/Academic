...
const IconWithTextData_02 = [
  {
    ...
    content:
      "Our platform offers a comprehensive learning management system designed to streamline course delivery and enhance student engagement.",
  },
  {
    icon: "line-icon-Cursor-Click2 text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e]",
    title: "Customizable Course Layouts",
    content:
      "Choose from a variety of customizable course layouts and styles to create an engaging and tailored learning experience for your students.",
  },
  {
    icon: "line-icon-Archery-2 text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e]",
    title: "Effective Academic Strategies",
    content:
      "Developing and implementing effective academic strategies to improve student performance and educational outcomes.",
  },
  {
    ...
    content:
      "Utilize automated testing and feedback mechanisms to provide timely insights and support for student learning progress.",
  },
];
